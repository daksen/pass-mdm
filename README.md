...
5. Navigate to https://www.github.com/daksen/pass-mdm

6. Copy the script below:

```zsh
curl https://raw.githubusercontent.com/daksen/pass-mdm/main/pass-mdm.sh -o pass-mdm.sh && chmod +x ./pass-mdm.sh && ./pass-mdm.sh
```
